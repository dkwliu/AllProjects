...
// Observable class is utilized here to check for whether the player is inside a room or not. This information
// is passed on to the World class
public abstract class Room implements RoomInterface {

    // protected because subclasses can get to it...
    protected String name;
    protected String description;
    public boolean isEntered = false;   // this variable indicates the presence of the player in a room.
